  ...
  async afterCreate(event) {
      ...
      try{
          await strapi.plugins['email'].services.email.send({
            to: 'clouddesk@mdp.com.pe',
            from: 'clouddesk@mdp.com.pe',
    ...
    <div style="width: 100%; background-color: #e3e3e3;">
        <div style="padding: 20px 10px 20px 10px;">
            ...
            <div class="text-email">
                ...
                <span style="display: block;">Asunto: ${result.asunto}</span>
                <span style="display: block;">Mensaje: ${result.mensaje}</span>
                <span style="display: block;">Política de privacidad: ${result.policy}</span>
